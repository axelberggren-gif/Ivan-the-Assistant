...
describe('sicilianDefense opening data', () => {
  it('has the expected identity', () => {
    expect(sicilianDefense.id).toBe('sicilian-defense')
    expect(sicilianDefense.userColor).toBe('black')
    expect(sicilianDefense.mainlines.length).toBeGreaterThanOrEqual(5)
    expect(sicilianDefense.trickLines.length).toBeGreaterThanOrEqual(3)
  })

  describe('mainlines', () => {
    for (const line of sicilianDefense.mainlines) {
  ...
  describe('trickLines', () => {
    for (const trap of sicilianDefense.trickLines) {
